...
class TrustBar {
  ...
  htmlRender(data) {
    const html = `
        <div class="qorix-review-trust-bar">
          ...
          <div class="qorix-review-trust-bar-verified">
            <svg viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M8 8.5C9.933 8.5 11.5 6.933 11.5 5C11.5 3.067 9.933 1.5 8 1.5C6.067 1.5 4.5 3.067 4.5 5C4.5 6.933 6.067 8.5 8 8.5Z" stroke="var(--verified-green)" stroke-width="1.3"/>
              <path d="M1.75 15C2.2 11.9 4.72 10 8 10C8.6 10 9.17 10.07 9.7 10.2" stroke="var(--verified-green)" stroke-width="1.3" stroke-linecap="round"/>
              <circle cx="14" cy="12.5" r="4" fill="var(--verified-green)"/>
