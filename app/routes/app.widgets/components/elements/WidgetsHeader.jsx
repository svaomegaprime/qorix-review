...
export default function WidgetsHeader({settings}) {
  const {showHeader, headerStyle, eyebrowLabel, heading, subheading, reviewStats} = settings || {}
    ...
    <>
      ...
      <div className="qr-reviews-header">
        ...
        <p className="qr-reviews-subtitle">{subheading}</p>
         ...
         {reviewStats == "Show review count & verified badge" && (<div className="qr-rating-summary">
         
              <div style={{display:"flex",}}>
          <div className="qr-rating-stars">
            {[...Array(5)].map((_, i) => (
              <span key={i} className="qr-star-icon">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="var(--qr-green)" xmlns="http://www.w3.org/2000/svg">
          ...
          <span className="qr-verified-badge">
            <span className="qr-verified-icon">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M17.5 14l1 1 2-2" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" fill="none" />
              </svg>
            </span>
            Verified reviews
          </span>
