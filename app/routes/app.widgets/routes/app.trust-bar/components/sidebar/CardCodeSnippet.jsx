...
export default function CardCodeSnippet({ customCss, handleCssChange }){
    ...
    return(
        <CustomSection>
            ...
            >
                <s-grid gap="small">
                    <s-paragraph color="subdued">Ratings on product cards require a one-time code snippet added to your theme. This only needs to be done once.</s-paragraph>
                    <CustomSection
                        background="#fff"
                        borderRadius="8px"
                        boxShadow="none"
                    ...
                    <s-ordered-list>
                        ...
                        <s-list-item>Open your product card template file and paste the snippet where you want ratings to appear</s-list-item>
                    </s-ordered-list>

                    <Text as="a" href="//qorix-currency-docs.softvenceomega.com" target="_blank" style={{ textDecoration: "none", fontSize: "15px", display: "flex", alignItems: "center", gap: "5px" }} color="#108848">
